...
function onResetClick() {
  ctx.fillStyle = "white"; // 리셋 = 하얀색으로 채우는 것과 같은 뜻
  ctx.fillRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
}
